			...
			<form action="" id="manage-project">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-sm" placeholder="Nombre del proyecto" name="name" value="<?php echo isset($name) ? $name : '' ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="status" id="status" class="custom-select custom-select-sm">
								...
								<option value="5" <?php echo isset($status) && $status == 5 ? 'selected' : '' ?>>Hecho</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<?php if ($_SESSION['login_type'] == 1) : ?>
						<div class="col-md-6">
							<div class="form-group">
								<label for="" class="control-label">Gerente de proyecto</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Miembros del equipo del proyecto</label>
