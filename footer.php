...
<!-- superponer barras de desplazamiento -->
<script src="assets/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- Aplicación AdminLTE -->
<script src="assets/dist/js/adminlte.js"></script>

<!-- Activos/complementos de PÁGINA -->
<!-- jQuery Mapael -->
...
<!-- Demostración del panel AdminLTE (esto es solo para fines de demostración) -->
<script src="assets/dist/js/pages/dashboard2.js"></script>
<!-- Tablas de datos y complementos -->
