			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<input type="text" placeholder="Asunto" class="form-control form-control-sm" name="subject" value="<?php echo isset($subject) ? $subject : '' ?>" required>
					</div>
					<div class="form-group">
				...
				<div class="col-md-7">
					<div class="form-group">
						<label for="">Comentario/Descripción del progreso</label>
