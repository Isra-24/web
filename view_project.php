...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							<dl>
								<dt><b class="border-bottom border-primary">Fecha de inicio</b></dt>
								<dd><?php echo date("d/m/Y", strtotime($start_date)) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">Fecha final</b></dt>
							...
							<dl>
								<dt><b class="border-bottom border-primary">Gerente de proyecto</b></dt>
								<dd>
									...
									<?php else : ?>
										<small><i>Administrador eliminado de la base de datos</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Progreso / Actividad de los miembros</b>
					<div class="card-tools">
						...
						<div class="post">
							...
							<div class="user-block">
								...
								<span class="description">
									...
									<span>Comenzar: <b><?php echo date('h:i A', strtotime($row['date'] . ' ' . $row['start_time'])) ?></b></span>
									<span> | </span>
...
<script>
	$('#new_task').click(function() {
		uni_modal("Nueva tarea para <?php echo ucwords($name) ?>", "manage_task.php?pid=<?php echo $id ?>", "mid-large")
	})
