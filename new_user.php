<head>
	<link rel="icon" href="img/tarea.ico">
</head>
<?php
?>
<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							<input type="text" name="firstname" placeholder="Nombre de usuario" class="form-control form-control-sm" required value="<?php echo isset($firstname) ? $firstname : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">Apellido</label>
							<input type="text" name="lastname" placeholder="Apellido" class="form-control form-control-sm" required value="<?php echo isset($lastname) ? $lastname : '' ?>">
						</div>
						<?php if ($_SESSION['login_type'] == 1) : ?>
							<div class="form-group">
								...
								<select name="type" id="type" class="custom-select custom-select-sm">
									...
									<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Gerente</option>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="email" placeholder="Tu E-mail" class="form-control form-control-sm" name="email" required value="<?php echo isset($email) ? $email : '' ?>">
							<small id="#msg"></small>
						</div>
						<div class="form-group">
							<label class="control-label">Contraseña</label>
							<input type="password" placeholder="Contraseña" class="form-control form-control-sm" name="password" <?php echo !isset($id) ? "required" : '' ?>>
						...
						<div class="form-group">
							...
							<input type="password" placeholder="Repite contraseña" class="form-control form-control-sm" name="cpass" <?php echo !isset($id) ? 'required' : '' ?>>
